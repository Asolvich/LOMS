...
## Версия 1.0.0-w2 · Неделя 2: Electron + SQLite + Python-редактор
...
## Планы (следующие недели)

- **Неделя 3**: React Flow drag-and-drop визуальный редактор, доработка Python-редактора
- **Неделя 4**: Версии/история в UI, сравнение результатов, исправление багов, улучшение визуального редактора
- **Неделя 5**: Тесты E2E, dark mode, онбординг
